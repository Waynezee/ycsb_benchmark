...
type Workload interface {
	...
	GenerateTransaction(ctx context.Context, db DB) (int64, string, string, []string, map[string][]byte)
	GenerateRead(ctx context.Context, db DB) (int64, string, string, []string, map[string][]byte)
	GenerateInsert(ctx context.Context, db DB) (int64, string, string, []string, map[string][]byte)
	GenerateUpdate(ctx context.Context, db DB) (int64, string, string, []string, map[string][]byte)
	Execute(ctx context.Context, db DB, op int64, table string, keyName string, fields []string, values map[string][]byte) error
}
